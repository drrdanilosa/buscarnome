...
const PLATFORM_DEFINITIONS = [
  ...
  { name: 'EksiSozluk', url: 'https://eksisozluk.com/profile/{username}', category: 'forum', priority: 'medium', checkType: 'content', adult: true },
  { name: 'ForumH', url: 'https://forumh.net/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ForumSexInSex', url: 'https://forumsexinsex.net/profile/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ForumSmotri', url: 'https://forumsmotri.club/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'HKForum', url: 'https://hkforum.net/profile/{username}', category: 'forum', priority: 'medium', checkType: 'content', adult: true, regional: 'HK' },
  ...
  { name: 'SexyEGirls', url: 'https://sexy-egirls.net/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'SocialMediaGirls', url: 'https://socialmediagirls.com/profile/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ThotHub', url: 'https://thothub.lol/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ViperGirls', url: 'https://vipergirls.net/profile/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'Xossip', url: 'https://xossip.com/member/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  ...
  { name: 'LeakSpy', url: 'https://leakspy.io/{username}', category: 'agregador', priority: 'high
  ...
  // Fóruns de Conteúdo Adulto adicionais
  { name: 'AnonIB.al', url: 'https://anonib.al/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'CariGold', url: 'https://carigold.com/member/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'CumOnPrintedPics', url: 'https://cumonprintedpics.com/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'DirtyShip', url: 'https://dirtyship.com/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'EGirlForums', url: 'https://egirlforums.net/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'EksiSozluk', url: 'https://eksisozluk.com/profile/{username}', category: 'forum', priority: 'medium', checkType: 'content', adult: true },
  ...
  { name: 'Kaskus', url: 'https://kaskus.co.id/profile/{username}', category: 'forum', priority: 'medium', checkType: 'content', adult: true, regional: 'ID' },
  { name: 'Lowyat', url: 'https://lowyat.net/user/{username}', category: 'forum', priority: 'medium', checkType: 'content', adult: true, regional: 'MY' },
  { name: 'NSFWTube', url: 'https://nsfwtube.club/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'SexyEGirls', url: 'https://sexy-egirls.net/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'SocialMediaGirls', url: 'https://socialmediagirls.com/profile/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ThotHub', url: 'https://thothub.lol/user/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ViperGirls', url: 'https://vipergirls.net/profile/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  ...
  // Sites de categoria "desconhecida"
  { name: 'Direct.me', url: 'https://direct.me/{username}', category: 'desconhecida', priority: 'medium', checkType: 'http' },
  { name: 'GetMy.Link', url: 'https://getmy.link/{username}', category: 'desconhecida', priority: 'medium', checkType: 'http' },
  { name: 'MYM.fans', url: 'https://mym.fans/{username}', category: 'desconhecida', priority: 'medium', checkType: 'content', adult: true },
  { name: 'Webz.io', url: 'https://webz.io/profile/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'A-rrajani', url: 'https://a-rrajani.com/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'AbsoluteAngelsBangkok', url: 'https://absolute-angels-bangkok.com/{username}', category: 'desconhecida', priority: 'medium', checkType: 'content', adult: true },
  { name: 'AcheiGatas', url: 'https://acheigatas.com/{username}', category: 'desconhecida', priority: 'medium', checkType: 'content', adult: true, regional: 'BR' },
  { name: 'AllPhotoBangkok', url: 'https://allphotobangkok.com/{username}', category: 'desconhecida', priority: 'medium', checkType: 'content', adult: true },
  { name: 'ArtMajeur', url: 'https://artmajeur.com/{username}', category: 'portfolio', priority: 'low', checkType: 'http' },
  { name: 'BaliPremiumTrip', url: 'https://balipremiumtrip.com/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'BohemianVisions', url: 'https://bohemianvisions.com/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'ByOlin', url: 'https://byolin.milouandolin.com/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'CameraPrive', url: 'https://cameraprive.com/{username}', category: 'cam', priority: 'medium', checkType: 'content', adult: true },
  { name: 'CelebLeaks.online', url: 'https://celebleaks.online/{username}', category: 'vazamento', priority: 'critical', checkType: 'content', adult: true, urgent: true },
  { name: 'EdiGo', url: 'https://edi-go.com/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'EmpireEagle', url: 'https://empireeagle.com.my/{username}', category: 'desconhecida', priority: 'low', checkType: 'http' },
  { name: 'EmyKat', url: 'https://emykat.com/{username}', category: 'desconhecida', priority: 'medium', checkType: 'content', adult: true },
  { name: 'FawnTail', url: 'https://fawntail.com/{username}', category: 'desconhecida', priority: 'medium', checkType: 'content', adult: true },
  { name: 'ForumBR', url: 'https://forumbr.net/{username}', category: 'forum', priority: 'medium', checkType: 'content', regional: 'BR' },
  { name: 'Fotolog', url: 'https://fotolog.com.br/{username}', category: 'images', priority: 'low', checkType: 'http', regional: 'BR' },
  { name: 'FStoppers', url: 'https://fstoppers.com/{username}', category: 'portfolio', priority: 'low', checkType: 'http' },
  { name: 'GozoFans', url: 'https://gozofans.com/{username}', category: 'desconhecida', priority: 'high', checkType: 'content', adult: true },
  { name: 'GPGuia', url: 'https://gpguia.net/{username}', category: 'escort', priority: 'high', checkType: 'content', adult: true, regional: 'BR' },
  { name: 'HardBR', url: 'https://hardbr.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true, regional: 'BR' },
  { name: 'Kavyar', url: 'https://kavyar.com/{username}', category: 'portfolio', priority: 'medium', checkType: 'http' },
  { name: 'LeakSX', url: 'https://leak.sx/user/{username}', category: 'vazamento', priority: 'critical', checkType: 'content', adult: true, urgent: true },
];

// Termos e palavras-chave para busca avançada (extraídos do JSON OSINT completo)
const SEARCH_KEYWORDS = [
  // Termos básicos OSINT
  "18+", "4chan", "500px", "8kun", "8muses", "acervo", "adult", "adult content", "adult_content", "alt account", "alternative account",
  "ana leticia", "anúncios", "archive", "backup account", "backup profile", "backup", "baianinha", "bio link", "biograph", "biography",
  "blogging", "blue check", "booking", "bot", "brazil", "brazilian", "buy content", "buy my content", "cam girl", "camgirl", "casting",
  "chat", "check bio", "close friends", "coleção", "compartilhe", "conteudo", "content creator", "content", "creator", "custom content",
  "dados", "data mining", "dating", "discord", "dm for prices", "dms open", "domingo tem", "ensaios", "escort", "exclusive", "explicit",
  "feet", "filter bypass", "forum", "fotos", "freelance", "gp", "hiring", "hookup", "image", "instagram", "intimate", "investigation",
  "investigação", "kink", "leak", "leaked content", "leaked", "lewd", "liberal", "link", "linkinbio", "links", "live", "mega", "model",
  "modelo", "monetization", "nsfw", "nude", "nudes", "official", "onlyfans", "osint", "paid", "patreon", "photos", "pics", "platform",
  ...
  "gaúcha", "gostosa", "gostoso", "hot.com.br", "massagem", "massagem com final feliz", "massagem tântrica", "massagista", "massoterapia",
  "mineira", "nordestina", "novinha", "novinho", "paulista", "putaria", "relaxamento", "relaxamento profundo", "ritmo intenso",
  "sacanagem", "safadinha", "safadão", "satisfeita", "satisfeito", "sem frescura", "semprecinto", "sigilo absoluto", "sigiloso",
  "só para amigos", "submissiva", "terapeuta", "terapêutica", "tesuda", "webcamgirl br",

  // Termos internacionais
  "actorsaccess", "adultwork", "ahegao", "album privado", "anime girl", "anon-ib", "anunciart", "anúncio pessoal", "art nude", "artstation",
  "atendimento", "ator", "atriz", "avnstars", "backstage", "bdsmlr", "camboy", "camming", "casa das primas", "cock tribute", "cosplay lewd",
  "cosplay nsfw", "cumtribute", "dating profile", "dick rate", "discord server", "ecchi", "erotic photography", "femboy", "femdom",
  "fetish content", "findom", "foot fetish", "furry nsfw", "hentai", "hentai foundry", "hentai girl", "herbicepscam", "hire me",
  "hypnohub", "imagefap", "imgur", "implied nude", "instagram model", "ismygirl", "iwantclips", "join my vip", "justcamit", "justforfans",
  "kink friendly", "krop", "leak.sx", "leakgirls", "lingerie", "link in bio", "mega folder", "mega link", "model profile", "monero",
  "monetize seu conteúdo", "nofacefreak_18", "ofans", "pacotes promocionais", "paid content", "payperview", "portfolio link",
  "premium content", "premium snapchat", "privacy leak", "private account", "private content", "private snap", "produtor", "reels", 
  "renda extra", "second account", "sell nudes", "selo azul", "snapcode", "sph", "sub4sub", "sugar baby", "sugar daddy", "superhq",
  "talenthouse", "telegram channel", "thefappeningblog", "tiktok viral", "tip menu", "torlinkbunker", "twitch streamer", "unlokme",
  "viewbug", "vip access", "vip content", "vipergirls", "vivastreet", "vk profile", "vsco", "vídeos personalizados", "waifu",
  "xbooru", "xhamsterlive", "xnxx", "xvideos", "xxxstreams", "youtube channel", "yubo", "zenfolio",
  
  // Termos técnicos OSINT
  "alias", "análise", "behavioural analytics", "breach", "crawler", "data collection", "data mining", "dork", "footprint", "forense",
  "geolocalização", "google dork", "hacking", "hash", "indexador", "informações", "intelligence", "ip log", "metadata", "monitoramento",
  "open source", "pattern", "perfilamento", "pesquisa", "rastreador", "rastreamento", "reconhecimento", "recon", "scraping", 
  "situational awareness", "tracker", "username",
