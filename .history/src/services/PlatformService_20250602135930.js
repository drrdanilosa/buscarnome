...
const PLATFORM_DEFINITIONS = [
  ...
  { name: 'TheFappeningBlog', url: 'https://thefappeningblog.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ThotHub.lol', url: 'https://thothub.lol/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ViperGirls.to', url: 'https://vipergirls.to/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ViperGirls.net', url: 'https://vipergirls.net/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'TorLinkBunker', url: 'https://torlinkbunker.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  
  // Fóruns Específicos Adicionais
  { name: 'AmateurFap', url: 'https://amateurfap.net/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'AnonIB.al', url: 'https://anonib.al/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'CariGold', url: 'https://carigold.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'CumOnPrintedPics', url: 'https://cumonprintedpics.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'DirtyShip', url: 'https://dirtyship.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'EgirlForums', url: 'https://egirlforums.net/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'EksiSozluk', url: 'https://eksisozluk.com/biri/{username}', category: 'forum', priority: 'medium', checkType: 'content' },
  { name: 'ForumH', url: 'https://forumh.net/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ForumSexInSex', url: 'https://forumsexinsex.net/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'ForumSmotri.club', url: 'https://forumsmotri.club/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'HKForum', url: 'https://hkforum.net/{username}', category: 'forum', priority: 'medium', checkType: 'content' },
  { name: 'ImgLeak', url: 'https://imgleak.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'Kaskus', url: 'https://kaskus.co.id/profile/{username}', category: 'forum', priority: 'medium', checkType: 'content' },
  { name: 'Lowyat', url: 'https://lowyat.net/member/{username}', category: 'forum', priority: 'medium', checkType: 'content' },
  { name: 'NSFWTube.club', url: 'https://nsfwtube.club/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'Sexy-EGirls', url: 'https://sexy-egirls.net/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'SocialMediaGirls', url: 'https://socialmediagirls.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  { name: 'XOssip', url: 'https://xossip.com/{username}', category: 'forum', priority: 'high', checkType: 'content', adult: true },
  ...
  // Sites de Acompanhantes Internacionais
  { name: 'sissymap.com', url: 'https://sissymap.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'adultsearch.com', url: 'https://adultsearch.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'listcrawler.eu', url: 'https://listcrawler.eu/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'scarletblue.com.au', url: 'https://scarletblue.com.au/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'escortdirectory.com', url: 'https://escortdirectory.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'skipthegames.com', url: 'https://skipthegames.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'tryst.link', url: 'https://tryst.link/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'eros.com', url: 'https://eros.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'slixa.com', url: 'https://slixa.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'eurogirlsescort.com', url: 'https://eurogirlsescort.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'adultfriendfinder.com', url: 'https://adultfriendfinder.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'ashley-madison.com', url: 'https://ashley-madison.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'cityvibe.com', url: 'https://cityvibe.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'bedpage.com', url: 'https://bedpage.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'locanto.com', url: 'https://locanto.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'classified-ads.com', url: 'https://classified-ads.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'onebackpage.com', url: 'https://onebackpage.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'backpage2.com', url: 'https://backpage2.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'megapersonals.com', url: 'https://megapersonals.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'yesbackpage.com', url: 'https://yesbackpage.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'classifiedads.com', url: 'https://classifiedads.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'ibackpage.com', url: 'https://ibackpage.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'backpagegals.com', url: 'https://backpagegals.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'backpage.click', url: 'https://backpage.click/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'hotgirls69.com', url: 'https://hotgirls69.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'spmistress.com', url: 'https://spmistress.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'www6.f-list.net', url: 'https://www6.f-list.net/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'tpgirls.com', url: 'https://tpgirls.com/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'datingpartner.net', url: 'https://datingpartner.net/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'elitepartner.de', url: 'https://elitepartner.de/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'parship.de', url: 'https://parship.de/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'c-date.com', url: 'https://c-date.com/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'joyclub.de', url: 'https://joyclub.de/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'poppen.de', url: 'https://poppen.de/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'secret.de', url: 'https://secret.de/{username}', category: 'escort', priority: 'medium', checkType: 'http', adult: true },
  { name: 'lovepoint.de', url: 'https://lovepoint.de/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'firstaffair.com', url: 'https://firstaffair.com/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },
  { name: 'casual-dating.com', url: 'https://casual-dating.com/{username}', category: 'escort', priority: 'low', checkType: 'http', adult: true },

  // Sites de Blog e Referência
  { name: 'medium.com', url: 'https://medium.com/{username}', category: 'blog', priority: 'high', checkType: 'http' },
  { name: 'substack.com', url: 'https://substack.com/{username}', category: 'blog', priority: 'high', checkType: 'http' },
  { name: 'blogger.com', url: 'https://blogger.com/{username}', category: 'blog', priority: 'medium', checkType: 'http' },
  { name: 'wordpress.com', url: 'https://wordpress.com/{username}', category: 'blog', priority: 'medium', checkType: 'http' },
  { name: 'tumblr.com', url: 'https://tumblr.com/{username}', category: 'blog', priority: 'high', checkType: 'http' },
  { name: 'ghost.org', url: 'https://ghost.org/{username}', category: 'blog', priority: 'low', checkType: 'http' },

  // Sites de Referência/LinkInBio
  { name: 'allmylinks.com', url: 'https://allmylinks.com/{username}', category: 'linkinbio', priority: 'medium', checkType: 'http' },
  { name: 'taplink.cc', url: 'https://taplink.cc/{username}', category: 'linkinbio', priority: 'low', checkType: 'http' },
  { name: 'shorby.com', url: 'https://shorby.com/{username}', category: 'linkinbio', priority: 'low', checkType: 'http' },
  { name: 'campsite.bio', url: 'https://campsite.bio/{username}', category: 'linkinbio', priority: 'low', checkType: 'http' },
  { name: 'milkshake.app', url: 'https://milkshake.app/{username}', category: 'linkinbio', priority: 'low', checkType: 'http' },

  // Sites da categoria "Desconhecida" do JSON
  { name: 'livejasmins.com', url: 'https://livejasmins.com/{username}', category: 'cam', priority: 'medium', checkType: 'http', adult: true },
  { name: 'stripchat.com', url: 'https://stripchat.com/{username}', category: 'cam', priority: 'medium', checkType: 'http', adult: true },
  { name: 'cam.yt', url: 'https://cam.yt/{username}', category: 'cam', priority: 'low', checkType: 'http', adult: true },
  { name: 'pornhub.com', url: 'https://pornhub.com/{username}', category: 'adult', priority: 'critical', checkType: 'http', adult: true },
  { name: 'xvideos.com', url: 'https://xvideos.com/{username}', category: 'adult', priority: 'critical', checkType: 'http', adult: true },
  { name: 'redtube.com', url: 'https://redtube.com/{username}', category: 'adult', priority: 'high', checkType: 'http', adult: true },
  { name: 'youporn.com', url: 'https://youporn.com/{username}', category: 'adult', priority: 'high', checkType: 'http', adult: true },
  { name: 'xhamster.com', url: 'https://xhamster.com/{username}', category: 'adult', priority: 'high', checkType: 'http', adult: true },
  { name: 'beeg.com', url: 'https://beeg.com/{username}', category: 'adult', priority: 'medium', checkType: 'http', adult: true },
  { name: 'tube8.com', url: 'https://tube8.com/{username}', category: 'adult', priority: 'medium', checkType: 'http', adult: true },
  { name: 'spankbang.com', url: 'https://spankbang.com/{username}', category: 'adult', priority: 'medium', checkType: 'http', adult: true },
  { name: 'eporner.com', url: 'https://eporner.com/{username}', category: 'adult', priority: 'medium', checkType: 'http', adult: true },
  { name: 'drtuber.com', url: 'https://drtuber.com/{username}', category: 'adult', priority: 'medium', checkType: 'http', adult: true },
  { name: 'nuvid.com', url: 'https://nuvid.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'gotporn.com', url: 'https://gotporn.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'vporn.com', url: 'https://vporn.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'slutload.com', url: 'https://slutload.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'tnaflix.com', url: 'https://tnaflix.com/{username}', category: 'adult', priority: 'medium', checkType: 'http', adult: true },
  { name: 'empflix.com', url: 'https://empflix.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'ixxx.com', url: 'https://ixxx.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'hotmovs.com', url: 'https://hotmovs.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'pornktube.com', url: 'https://pornktube.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
  { name: 'pornone.com', url: 'https://pornone.com/{username}', category: 'adult', priority: 'low', checkType: 'http', adult: true },
