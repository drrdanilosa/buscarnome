/**
 * DeepAlias Hunter Pro - Plataformas de Fallback
 * @author drrdanilosa
 * @version 5.0.0
 * @date 2025-06-03
 */

// Plataformas hardcoded para uso em caso de falha no carregamento dos arquivos JSON
...
if (typeof module !== 'undefined') {
  module.exports = { FALLBACK_PLATFORMS };
} else {
  window.FALLBACK_PLATFORMS = FALLBACK_PLATFORMS;
}