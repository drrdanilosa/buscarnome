...
export class DependencyContainer {
  ...
  async initialize() {
    ...
    const torConnector = new TorConnector(storageService, eventBus);
    this.register('torConnector', torConnector);

    const osintConnector = new OSINTConnector(storageService, eventBus);
    this.register('osintConnector', osintConnector);
